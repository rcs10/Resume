...
\entry* \textbf{Other Misc., Projects} Digit Identifier and spam email classifier built as a part of AndrewNG's ML Beginners course, a web interface to show the working of a processor and actively contributing in the android open source community.
\end{rubric}